...
- Em `ruleRelationship.priorityRank`, numeros menores significam maior precedencia. Ordene por especificidade operacional: regra com ID CRM de produto/oferta + ID CRM de bundle vem antes de regra apenas com ID CRM de produto/oferta; regra com ID CRM vem antes de regra somente por chargecode/billing. Use essa ordem mesmo quando a regra mais especifica tiver o mesmo preco esperado de uma regra mais generica.
